...
class MovieDetailVM {
    ...
    private (set) var dataModels: [Movie] = []
    ...
    func viewDidLoad() {
        ...
        dataModel = DataGenerator.movies.first
    ...
    private func movieData() -> Movie {
        return DataGenerator.movies.first!
    }
    ...
    private func configureOutput() {
        ...
        dataModels = DataGenerator.movies
    }
